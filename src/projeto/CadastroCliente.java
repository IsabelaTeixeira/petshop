...
public class CadastroCliente extends JPanel
{
    ...
    {      
         UIManager.put("Label.font", fontee);
         setLayout(null);
         lblnum1 = new JLabel("Código do cliente: ");
         lblnum1.setBounds(130,80,200,20);
         lblnum2 = new JLabel("Nome do cliente: ");
         lblnum2.setBounds(130,140,200,20);
         lblnum3 = new JLabel("CPF do cliente: ");
              ...
              try
                {
                  ...
                  BufferedReader br = new BufferedReader(new FileReader(arq + "teste.txt"));
          ...
          public void actionPerformed(ActionEvent e)
          {
            if(txtnum1.getText().equals(""))
            {
                ...
                txtnum3.requestFocus();
                    ...
                    try
                    {
                        PrintWriter out = new PrintWriter(txtnum1.getText() + "teste.txt");
